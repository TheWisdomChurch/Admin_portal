        ...
        <div className="mx-auto flex h-[72px] w-full max-w-[1480px] items-center justify-between px-4 min-[390px]:px-5 sm:h-20 sm:px-8 lg:px-12">
          <Link href="/" className="flex min-w-0 items-center gap-3" aria-label="Wisdom Church administration home">
            ...
            <div className="hidden min-w-0 leading-none min-[360px]:block">
              <p className="truncate text-sm font-black tracking-[-0.02em]">The Wisdom Church</p>
          ...
          <div className="relative mx-auto grid min-h-[calc(100svh-72px)] w-full max-w-[1480px] items-center gap-12 px-4 py-12 min-[390px]:px-5 sm:min-h-[calc(100svh-80px)] sm:px-8 sm:py-20 lg:grid-cols-[minmax(0,0.88fr)_minmax(560px,1.12fr)] lg:gap-14 lg:px-12 lg:py-24 xl:grid-cols-[minmax(0,0.9fr)_minmax(620px,1.1fr)]">
            <div className="max-w-2xl">
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                <Link href="/login" className="inline-flex h-13 items-center justify-center gap-2 rounded-2xl bg-[#171511] px-6 text-sm font-black text-white shadow-[0_12px_30px_rgba(23,21,17,0.18)] transition hover:-translate-y-0.5 hover:bg-[#302d27] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#b88920]">
                  Enter administration <ArrowRight className="h-4 w-4" />
                </Link>
                <Link href="/register" className="inline-flex h-13 items-center justify-center rounded-2xl border border-black/10 bg-white/75 px-6 text-sm font-black text-[#29261f] transition hover:-translate-y-0.5 hover:border-black/20 hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#b88920]">
                  Request an account
                </Link>
              </div>
            ...
            <div className="relative mx-auto min-w-0 w-full max-w-3xl lg:mx-0" aria-label="Administration interface preview">
                ...
                <div className="rounded-[23px] bg-[#fdfcf9]">
                  <div className="flex items-center justify-between border-b border-black/[0.07] px-5 py-4 sm:px-6">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="hidden text-[10px] font-black uppercase tracking-[0.16em] text-[#8b857a] sm:inline">Operations overview</span>
                    </div>
                    <div className="flex items-center gap-2 rounded-full bg-emerald-50 px-2.5 py-1 text-[10px] font-black text-emerald-700"><span className="h-1.5 w-1.5 rounded-full bg-emerald-500" /> Live</div>
                  </div>
                  ...
                  <div className="grid sm:min-h-[490px] sm:grid-cols-[140px_1fr] xl:grid-cols-[150px_1fr]">
                    <aside className="hidden border-r border-black/[0.07] bg-[#f8f6f1] p-4 sm:block">
                      <div className="mb-6 flex items-center gap-2 px-2"><Image src="/OIP.webp" alt="" width={26} height={26} className="h-7 w-7 rounded-lg object-cover" /><span className="text-[10px] font-black">WISDOM HQ</span></div>
                      ...
                      <div className="mt-8 rounded-2xl border border-[#b88920]/20 bg-[#f3eddf] p-3">
                        ...
                        <p className="mt-2 text-[10px] font-black text-[#4a4130]">Protected workspace</p>
                    ...
                    <div className="min-w-0 p-3 min-[390px]:p-4 sm:p-5 xl:p-6">
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0"><p className="text-[10px] font-black uppercase tracking-[0.16em] text-[#9b741b]">Secure workspace</p><h2 className="mt-1 text-lg font-black tracking-tight min-[390px]:text-xl">Ministry at a glance</h2></div>
                      ...
                      <div className="mt-6 grid grid-cols-2 gap-2.5 lg:grid-cols-4">
                        {[['People', 'Unified'], ['Events', 'Planned'], ['Responses', 'Tracked'], ['Serving', 'Visible']].map(([label, value]) => (
                          <div key={label} className="min-w-0 rounded-2xl border border-black/[0.07] bg-white p-3 shadow-sm"><p className="truncate text-[9px] font-bold uppercase tracking-wide text-[#8b857a]">{label}</p><p className="mt-2 truncate text-sm font-black tracking-tight min-[390px]:text-base">{value}</p></div>
                        ))}
                      </div>

                      <div className="mt-4 grid gap-3 lg:grid-cols-[1.15fr_0.85fr]">
                        <div className="rounded-2xl border border-black/[0.07] bg-white p-4 shadow-sm">
                          <div className="flex items-center justify-between gap-3"><div><p className="text-xs font-black">Operational readiness</p><p className="mt-1 text-[9px] text-[#8b857a]">Live after secure sign-in</p></div><span className="rounded-full bg-[#f3eddf] px-2 py-1 text-[9px] font-black uppercase tracking-wide text-[#785711]">Connected</span></div>
                        ...
                        <div className="rounded-2xl bg-[#201d18] p-4 text-white shadow-sm">
                          ...
                          <p className="mt-4 text-xs font-black">People care today</p>
                      ...
                      <div className="mt-3 flex items-center justify-between rounded-2xl border border-[#b88920]/20 bg-[#f5efe1] p-3">
                        <div className="flex min-w-0 items-center gap-3"><span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-[#ded1ae]"><Sparkles className="h-4 w-4 text-[#785711]" /></span><div className="min-w-0"><p className="text-[10px] font-black">Leadership intelligence</p><p className="mt-0.5 truncate text-[9px] text-[#777166]">Recommendations generated from current operational data.</p></div></div>
              ...
              <div className="absolute -bottom-6 -left-3 hidden rounded-2xl border border-black/10 bg-white p-3 shadow-xl sm:flex sm:items-center sm:gap-3">
                ...
                <div><p className="text-[10px] font-black">Secure by design</p><p className="mt-0.5 text-[9px] text-[#777166]">MFA · permissions · audit history</p></div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto grid w-full max-w-[1480px] gap-px bg-black/[0.07] sm:grid-cols-2 lg:grid-cols-4">
            {capabilities.map(({ icon: Icon, title, description }) => (
              <article key={title} className="bg-white px-6 py-9 sm:px-8 lg:py-11">
                ...
                <h2 className="mt-5 text-sm font-black tracking-tight">{title}</h2>
        ...
        <section className="bg-[#171511] px-5 py-16 text-white sm:px-8 lg:px-12 lg:py-20">
          <div className="mx-auto flex w-full max-w-[1480px] flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <Link href="/login" className="inline-flex h-12 items-center justify-center gap-2 rounded-2xl bg-[#d7b85f] px-6 text-sm font-black text-[#171511] transition hover:bg-[#e4ca80]">Sign in securely <ArrowRight className="h-4 w-4" /></Link>
              <Link href="/register" className="inline-flex h-12 items-center justify-center rounded-2xl border border-white/15 px-6 text-sm font-black text-white transition hover:bg-white/10">Request access</Link>
            </div>
          </div>
        </section>
      </main>

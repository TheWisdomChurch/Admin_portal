...
function summaryRows(o: ChurchOverview): Array<[string, string | number]> {
  return [
    ...
    ['New members this month', o.people.newMembers30d],
    ...
    ['Form submissions (30 days)', o.intake.submissions30d.current],
    ['Submissions vs prior 30 days', formatDeltaPct(o.intake.submissions30d.deltaPct)],
    ...
    ['Attendance (30 days)', o.engagement.attendance30d.current],
...
export async function downloadExecutiveReportPdf(
  ...
  const kpis: Array<[string, string]> = [
    ...
    ['New members this month', `${o.people.newMembers30d}  (${formatDeltaPct(o.people.memberGrowth.deltaPct)} vs last month)`],
    ['Form submissions (30d)', `${o.intake.submissions30d.current}  (${formatDeltaPct(o.intake.submissions30d.deltaPct)})`],
    ...
    ['Volunteer coverage', formatPercent(o.people.workforce.coverageRate)],
    ['Attendance (30d)', o.engagement.attendance30d.current.toLocaleString()],
